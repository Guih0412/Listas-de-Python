...
# Exercicio A: O que o seguinte programa (dado na forma de pseucódigo) imprime? 
# x = 2
# y = 5
# se y > 8 então
#   y = y * 2
...
# Exercicio B: Quantas  vezes  o  trecho  de  pseudocódigo  seguinte  imprime  'oi'?
...
# Exercicio C: Entre  1067  e  3627  (inclusive),  quantos  números  são  pares  e  também divisíveis por 7?  

divisivel_por_14 = 0
for numero in range(1067, 3628):
    if numero % 2 == 0 and numero % 7 == 0:
    # Ou então, if numero % 14 == 0:
        divisivel_por_14 = divisivel_por_14 + 1
print(divisivel_por_14)        
# Resposta: 183



# Exercicio D: Daniela é uma pessoa muito supersticiosa.
...
for numero in range(18644, 33088):
    if '2' in str(numero) and '7' not in str(numero):
        numero_sortudo = numero_sortudo + 1
print(numero_sortudo)



# Exercicio E: Na  pacata  vila  campestre  de  Ponteironuloville,  todos  os  telefones  têm  6 
...
quantidade_fones = 0
for f in fones:
    if chato(f) and legal(f) and azar(f):
        quantidade_fones = quantidade_fones + 1
print(quantidade_fones)
# Resposta: 39 ou 40                
